...
void setup() {
  ...
  strs[0][0] = "Hey there!";
  strs[0][1] = "My name is Džiugas Pečiulevičius.";

  strs[1][0] = "I'm a Web Developer & Computer Science student";
  strs[1][1] = "at Vilnius University of Applied Science in Vilnius.";

  strs[2][0] = "I've created apps, websites, and art using what I've learned.";
  strs[2][1] = "You can even find the Processing source code for this below!";

  strs[3][0] = "Feel free to reach out to say hi!";
  strs[3][1] = "phone: +37067946664 | email: dziugaspeciulevicius@gmail.com";
}
